namespace PUJASM.ERP.ViewModels.Suppliers.Purchase_Return
{
    ...
    internal class PurchaseReturnVM : ViewModelBase<PurchaseReturnTransaction>
    {
                    ...
                    var purchaseReturnTransactionFromDatabase = context.PurchaseReturnTransactions
                        ...
                        .SingleOrDefault(
                            purchaseReturnTransaction =>
                                purchaseReturnTransaction.PurchaseReturnTransactionID.Equals(value));
        ...
        public SupplierVM SelectedPurchaseTransactionSupplier
        {
            ...
            set
            {
                SetProperty(ref _selectedPurchaseTransactionSupplier, value, () => SelectedPurchaseTransactionSupplier);
            }
        }
